 ...
 *	treese@crl.dec.com
 *
 *	$Source: /allsys/u1/uaf/kate/cvsroot/xcoast/w_dir.c,v $
 *
 *	    COPYRIGHT 1990
 *	  DIGITAL EQUIPMENT CORPORATION
...
extern Widget	file_selfile, file_dir,
		file_flist, file_dlist, file_mask;
...
extern void file_msg (const char *format, ...);
...
void
FileSelected(Widget w, XtPointer client_data, XtPointer ret_val)
{
...
/* ARGSUSED */
void
DirSelected(Widget w, XtPointer client_data, XtPointer ret_val)
{
    XawListReturnStruct *ret_struct = (XawListReturnStruct *) ret_val;
...
void
create_dirinfo(Widget parent, Widget below, Widget *ret_beside, Widget *ret_below, Widget *mask_w, Widget *dir_w, Widget *flist_w, Widget *dlist_w)
{
